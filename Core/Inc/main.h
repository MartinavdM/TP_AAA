...
#include "speed_enslavement.h"
#include "current_enslavement.h"
...
#define W_Imes_ADC1_IN15_Pin GPIO_PIN_0
#define W_Imes_ADC1_IN15_GPIO_Port GPIOB
#define V_Imes_ADC1_IN12_Pin GPIO_PIN_1
#define V_Imes_ADC1_IN12_GPIO_Port GPIOB
